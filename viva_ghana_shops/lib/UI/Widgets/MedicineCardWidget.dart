...
//       _MedicineCardWidgetState(this.medicineName,  this.itemIndex);
// }
...
//     price = DatabaseFunctionClass.cartList[itemIndex].product.price.toString();
//     img = DatabaseFunctionClass.cartList[itemIndex].product.img;

//     amount = DatabaseFunctionClass.cartList[itemIndex].amount.toString();
